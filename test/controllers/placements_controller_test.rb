...
class PlacementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create placement" do
    assert_difference('Placement.count') do
      post placements_url, params: { placement: { artwork_id: @placement.artwork_id, gallery_id: @placement.gallery_id, order: @placement.order } }
    end
  ...
  test "should update placement" do
    patch placement_url(@placement), params: { placement: { artwork_id: @placement.artwork_id, gallery_id: @placement.gallery_id, order: @placement.order } }
