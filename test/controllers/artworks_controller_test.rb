...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { artist_id: @artwork.artist_id, blocked: @artwork.blocked, image: @artwork.image, integer: @artwork.integer, title: @artwork.title, year: @artwork.year } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { artist_id: @artwork.artist_id, blocked: @artwork.blocked, image: @artwork.image, integer: @artwork.integer, title: @artwork.title, year: @artwork.year } }
