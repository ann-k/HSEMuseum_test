...
class CollaborationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collaboration" do
    assert_difference('Collaboration.count') do
      post collaborations_url, params: { collaboration: { artist_id: @collaboration.artist_id, collective_id: @collaboration.collective_id } }
    end
  ...
  test "should update collaboration" do
    patch collaboration_url(@collaboration), params: { collaboration: { artist_id: @collaboration.artist_id, collective_id: @collaboration.collective_id } }
